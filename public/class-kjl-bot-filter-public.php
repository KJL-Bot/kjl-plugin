	...
	public function get_html_for_books($the_query) 
	{
		...
		if ( $the_query->have_posts() )  {
			...
			while ( $the_query->have_posts() ) {
				...
				$content .=  get_post_meta(get_the_ID(), 'publisher_jlp_nominated')[0] == "1" ? ' <small><span class="badge bg-secondary" title="Deutscher Jugendliteraturpreis">DJLP</span></small>' : '';
				$content .=  get_post_meta(get_the_ID(), 'publisher_kimi_nominated')[0] == "1" ? ' <small><span class="badge bg-secondary" title="Siegel für Vielfalt in Kinder- und Jugendliteratur">KIMI</span></small>' : '';
				$content .= '<br>';
